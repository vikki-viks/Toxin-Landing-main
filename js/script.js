    ...
    ($.datepicker._get = function (t, e) {
      ...
      switch (a) {
        ...
        case 'multiple':
          ...
          switch (
            (n ||
              ((n = new _datepickerExtension()),
              $(this.dpDiv).data('datepickerExtensionRange', n)),
            (n.range = a),
            (n.range_multiple_max = t.settings.range_multiple_max || 0),
            e)
          ) {
            case 'onSelect':
              var r = i;
    ...
    ($.datepicker._setDate = function (t, e, i) {
      ...
      switch (a) {
        case 'period':
          ...
          break;
        case 'multiple':
          ('object' != typeof e || void 0 == e.length) && (e = [e]),
            (s.dates = []),
            (s.datesText = []);
          var n = this;
          $.map(e, function (e) {
            $.datepicker._setDate_original(t, e, i),
              s.dates.push(n._getDate(t)),
              s.datesText.push(n._formatDate(t));
          }),
            s.setClassActive(t);
      }
    });
    ...
    (this.range = !1),
      ...
      (this.onSelectPeriod = function (t, e) {
        this.step++,
          (this.step %= 2),
          this.step
            ? ((this.startDate = this.getSelectedDate(e)),
              (this.endDate = this.startDate),
              (this.startDateText = t),
      ...
      (this.onSelectMultiple = function (t, e) {
        ...
        -1 != a ? this.dates.splice(a, 1) : this.dates.push(i),
          -1 != s ? this.datesText.splice(s, 1) : this.datesText.push(t),
          this.range_multiple_max &&
            this.dates.length > this.range_multiple_max &&
            (this.dates.splice(0, 1), this.datesText.splice(0, 1));
      }),
      (this.fillDay = function (t, e) {
        var i = e[1];
        switch (
          (1 == t.getDate() && (i += ' first-of-month'),
          t.getDate() ==
      ...
      (this.fillDayPeriod = function (t, e) {
        ...
        var i = e[1];
        return (
          t >= this.startDate && t <= this.endDate && (i += ' selected'),
          t.getTime() == this.startDate.getTime() && (i += ' selected-start'),
          t.getTime() == this.endDate.getTime() && (i += ' selected-end'),
          (e[1] = i.trim()),
          e
        );
      }),
      (this.fillDayMultiple = function (t, e) {
        ...
        return (
          ...
          a && (i += ' selected selected-start selected-end'),
          (e[1] = i.trim()),
          e
        );
      }),
      ...
      (this.setClassActive = function (t) {
        var e = this;
        setTimeout(function () {
          $('td.selected > *', t.dpDiv).addClass('ui-state-active'),
            'multiple' == e.range &&
              $('td:not(.selected)', t.dpDiv)
